...
user2 = User.create name:'Grant Test2', email: 'grantgrant@test.co', password: 'chicken', avatar: 'https://jsns.eu/components/com_jsn/assets/img/default.jpg', age:22, height:1.65, weight:62, is_admin: false
